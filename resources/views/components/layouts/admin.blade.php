...
<body x-data="{ sidebarOpen: false }" class="h-full font-sans text-slate-800 bg-slate-50 flex flex-col overflow-hidden">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'" 
        ...
        <div class="p-3.5 border-t border-slate-100 space-y-2">
            <a href="@tenantUrl('booking.index')" target="_blank" class="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 transition-colors">
                View Venue Site ↗
            </a>
