    ...
    <div class="bg-slate-950 text-white text-xs py-2 px-4 border-b border-slate-800 relative z-50">
        <div class="max-w-7xl mx-auto flex items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-slate-300 font-semibold text-xs hidden sm:inline">&bull; Current Tenant:</span>
            ...
            <div class="hidden md:flex items-center gap-3">
                <a href="{{ route('admin.dashboard') }}" class="text-brand-400 hover:text-brand-300 font-bold flex items-center gap-1 transition-colors text-xs" style="color: {{ $brandColor }};">
                    <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:flex items-center gap-4">
                    <a href="{{ route('customer.my-bookings') }}" class="text-sm font-medium text-slate-700 hover:text-slate-900 transition-colors px-3 py-2">
                        Sign In
                    </a>
